...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def load_state_dict(self, state_dict: Mapping[str, Any], strict: bool = True):
        if "transformer.text_model.embeddings.position_ids" in state_dict:
            state_dict.pop("transformer.text_model.embeddings.position_ids") # it seems that this is removed from the model in recent transformers versions
