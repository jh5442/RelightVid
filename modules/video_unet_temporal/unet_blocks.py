...
class CrossAttnDownBlock3D(nn.Module):
    def __init__(
        ...
        self.attentions = nn.ModuleList(attentions) # spatial attention
        self.resnets = nn.ModuleList(resnets) # downsample
        self.motion_modules = nn.ModuleList(motion_modules) # motion layer
